	...
	<div class="login">
		...
		<div class="qlogin" id="qlogin">
			<div class="web_login" align="center">
				<form action="${pageContext.request.contextPath}/login.action" method="post"  onsubmit="return true">
					...
					<div style="padding-left: 100px; margin-top: 20px;">
						<button class="btn btn-primary btn-lg" style="width:150px" type="submit">登录</button>
					</div>
				</form>
			</div>
		</div>
